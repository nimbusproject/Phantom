...
def add_one_user(authz, dtrs_client, access_key, access_secret, pub_key, email, username):
    ...
    hosts = {"hotel": "https://svc.uc.futuregrid.org:8444", "sierra" : "https://s83r.idp.sdsc.futuregrid.org:8444", "alamo": "https://nimbus.futuregrid.tacc.utexas.edu:8444", "foxtrot": "https://f1r.idp.ufl.futuregrid.org:9444"}
    print "public key is %s" % (pub_key)
    for host in hosts:
        try:
            dtrs_client.add_credentials(access_key, "common::" + host, creds)
